...
app.post("/upload", upload.single("videoFile"), (req, res) => {
  ...
  res.send(`
        ...
        <a href="../../${folderName}/uploaded_video.mp4">Download Original Video</a> | 
        <a href="../../${folderName}/video_720p.mp4">Download 720p</a> | 
        <a href="../../${folderName}/video_480p.mp4">Download 480p</a>
    `);
});
